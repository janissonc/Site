...
$alterar = $_POST['editar_receita'];
$id = substr("$alterar", 15);
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
<body>
	...
	<center>
		<div class="login">
				...
				<form action="alter_receita.php" method="Post">
					  ...
					  <div class="form-group">
						...
						<br/>
					   <input type="submit" class="btn btn-primary" name="receita" value="Enviar <?php echo"$id" ?>"></button>
